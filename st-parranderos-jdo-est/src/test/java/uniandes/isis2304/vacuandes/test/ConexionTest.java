    ...
    public void normalAccessTest ()
  	{
  	  	try
		{
			...
			parranderos = new VacuAndes (openConfig (CONFIG_TABLAS_A));
...
//			System.out.println (msg);
    ...
    public void baseDatosInaccesible ()
    {
		try
		{
			...
			parranderos = new VacuAndes (openConfig (CONFIG_TABLAS_ERR_DS));
...
//			e.printStackTrace();
    ...
    public void usuarioInvalidoTest ()
    {
		try
		{
			...
			parranderos = new VacuAndes (openConfig (CONFIG_TABLAS_ERR_USER));
...
//			e.printStackTrace();
    ...
    public void tablaInexistenteTest ()
    {
		...
		try
		{
			...
			parranderos = new VacuAndes (openConfig (CONFIG_TABLAS_B));
		}
		catch (Exception e)
		{
//			e.printStackTrace();
