...
package uniandes.isis2304.vacuandes.interfazDemo;
...
import uniandes.isis2304.vacuandes.interfazApp.PanelDatos;
import uniandes.isis2304.vacuandes.negocio.VOBar;
import uniandes.isis2304.vacuandes.negocio.VOBebedor;
import uniandes.isis2304.vacuandes.negocio.VOBebida;
import uniandes.isis2304.vacuandes.negocio.VOGustan;
import uniandes.isis2304.vacuandes.negocio.VOSirven;
import uniandes.isis2304.vacuandes.negocio.VOTipoBebida;
import uniandes.isis2304.vacuandes.negocio.VOVisitan;
...
public class InterfazVacuAndesDemo extends JFrame implements ActionListener
{
	/* ****************************************************************
	 * 			Constantes
	 *****************************************************************/
	 ...
	 */
	private static Logger log = Logger.getLogger(InterfazVacuAndesDemo.class.getName());
...
//			e.printStackTrace();
	...
	public void actionPerformed(ActionEvent pEvento)
	{
        ...
        try 
        {
			Method req = InterfazVacuAndesDemo.class.getMethod ( evento );			
			req.invoke ( this );
		} 
        catch (Exception e) 
        {
    ...
    public static void main( String[] args )
    {
        try
        {
            ...
            InterfazVacuAndesDemo interfaz = new InterfazVacuAndesDemo( );
