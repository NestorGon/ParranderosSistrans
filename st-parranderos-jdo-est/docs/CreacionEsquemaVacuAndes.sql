...
(DESCRIPCION VARCHAR2(255),
 ...
 CONSTRAINT FK_CONDICION_PRIORIZACION_NUMERO_ETAPA FOREIGN KEY (NUMERO_ETAPA) REFERENCES ETAPA(NUMERO),
 CONSTRAINT CK_CONDICION_PRIORIZACION_DESCRIPCION CHECK (DESCRIPCION <> ''));
